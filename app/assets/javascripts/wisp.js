...
var style = {font: "32px Georgia", fill: "#000000", align: "left" }; // font styles
...
function plotOver(item) {
    game.add.tween(plotButton).to( { alpha: 1 }, 100, Phaser.Easing.Linear.None, true, 0, 0, false);   
}
...
function plotOut(item) {
    game.add.tween(plotButton).to( { alpha: 0.6 }, 100, Phaser.Easing.Linear.None, true, 0, 0, false);
}
